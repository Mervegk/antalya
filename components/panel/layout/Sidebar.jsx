...
export function SidebarItem({ icon, text, alert, link }) {
  ...
  return (
    <li className={`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-all duration-300 ease-linear ${collapsed ? '' : 'justify-center group'} ${window.location.pathname == link ? 'sidebar-menu-active' : 'sidebar-menu'} `}
